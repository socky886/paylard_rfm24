...
#define RX_PLOAD_WIDTH	10		//用户数据宽度


//全局变量声明
extern uchar code TX_ADDRESS[TX_ADR_WIDTH];  // 定义一个静态发送地址
extern uchar TX_BUF[TX_PLOAD_WIDTH];
extern uchar RX_BUF[TX_PLOAD_WIDTH];
extern uchar g_cFirstPacketFlag;
...
#define TRX_OK			0x60  // TX_DS he RX_DR均产生，适用于ACK with PAYLOAD
